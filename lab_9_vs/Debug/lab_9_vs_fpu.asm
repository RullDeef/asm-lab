...
; Line 167
	...
	fild	QWORD PTR tv439[ebp]
	fstp	QWORD PTR tv442[ebp]
	fld	QWORD PTR tv442[ebp]
...
; Line 176
	...
	mov	DWORD PTR tv479[ebp+4], edx
	fild	QWORD PTR tv479[ebp]
	fstp	QWORD PTR tv482[ebp]
	fld	QWORD PTR tv482[ebp]
	fdiv	QWORD PTR __real@40f86a0000000000
...
; Line 185
	...
	mov	DWORD PTR tv516[ebp+4], edx
	fild	QWORD PTR tv516[ebp]
	fstp	QWORD PTR tv519[ebp]
	fld	QWORD PTR tv519[ebp]
	fdiv	QWORD PTR __real@40f86a0000000000
...
; Line 194
	...
	mov	DWORD PTR tv553[ebp+4], edx
	fild	QWORD PTR tv553[ebp]
	fstp	QWORD PTR tv556[ebp]
...
; Line 203
	...
	mov	DWORD PTR tv590[ebp+4], edx
	fild	QWORD PTR tv590[ebp]
	fstp	QWORD PTR tv593[ebp]
	fld	QWORD PTR tv593[ebp]
	fdiv	QWORD PTR __real@40f86a0000000000
	fstp	QWORD PTR tv273[ebp]
	mov	esi, esp
	sub	esp, 8
	fld	QWORD PTR tv273[ebp]
	fstp	QWORD PTR [esp]
...
; Line 212
	...
	fild	QWORD PTR tv627[ebp]
	fstp	QWORD PTR tv630[ebp]
	fld	QWORD PTR tv630[ebp]
	fdiv	QWORD PTR __real@40f86a0000000000
...
; Line 228
	...
	fld	QWORD PTR _fpu_pi$14[ebp]
	fstp	QWORD PTR tv364[ebp]
	mov	esi, esp
	sub	esp, 8
	fld	QWORD PTR tv364[ebp]
	fstp	QWORD PTR [esp]
...
; Line 231
	sub	esp, 8
	fld	QWORD PTR __real@40091eb851eb851f
	fstp	QWORD PTR [esp]
	call	?test_sin@@YAXO@Z			; test_sin
	add	esp, 8
; Line 232
...
; Line 233
	sub	esp, 8
	fld	QWORD PTR __real@400921fd1569f490
	fstp	QWORD PTR [esp]
	call	?test_sin@@YAXO@Z			; test_sin
	add	esp, 8
; Line 236
